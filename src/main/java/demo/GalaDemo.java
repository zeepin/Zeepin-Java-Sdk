...
//            System.out.println(Helper.toHexString(acct33.serializePublicKey()));
            ...
            if (false) {
                String hash = zptSdk.nativevm().gala().sendApprove(acct0,acct1.getAddressU160().toBase58(),100,payerAcct,30000,0);
                System.out.println(hash);
//                Thread.sleep(6000);
                System.out.println(zptSdk.nativevm().gala().queryAllowance(acct6.getAddressU160().toBase58(), acct1.getAddressU160().toBase58()));
...
//                System.out.println(zptSdk.getConnect().getAllowance("zpt",acct0.getAddressU160().toBase58(), acct1.getAddressU160().toBase58()));
            ...
            if (false) {
                String hash = zptSdk.nativevm().gala().sendTransferFrom(acct1,acct6.getAddressU160().toBase58(),acct1.getAddressU160().toBase58(),100,payerAcct,30000,0);
                Thread.sleep(6000);
                System.out.println(zptSdk.getConnect().getSmartCodeEvent(hash));
            }
            if(false){
                System.out.println(zptSdk.nativevm().gala().queryBalanceOf(acct6.getAddressU160().toBase58()));
                //System.out.println(zptSdk.nativevm().zpt().queryTotalSupply());
//                System.exit(0);
                //String hash = zptSdk.nativevm().zpt().sendTransfer(acct0,acct1.getAddressU160().toBase58(),11,acct0,zptSdk.DEFAULT_GAS_LIMIT,0);
                //System.out.println(hash);
                //Thread.sleep(6000);

              //  zptSdk.nativevm().gala().claimOng(acct0,acct0.getAddressU160().toBase58(),49520000000000L,acct0,zptSdk.DEFAULT_GAS_LIMIT,0);
                
            }
            if(false){
                System.out.println(zptSdk.nativevm().gala().unboundGala(acct6.getAddressU160().toBase58()));
                ...
                System.out.println(zptSdk.nativevm().gala().queryBalanceOf(acct0.getAddressU160().toBase58()));
                System.out.println(zptSdk.nativevm().gala().queryAllowance(acct0.getAddressU160().toBase58(),acct0.getAddressU160().toBase58()));
...
//                String hash = zptSdk.nativevm().zpt().sendTransfer(acct0, acct1.getAddressU160().toBase58(), 30L, payerAcct, 30000, 0);
            ...
            if(true){
                System.out.println(zptSdk.nativevm().gala().unboundGala(acct0.getAddressU160().toBase58()));
                String hash = zptSdk.nativevm().gala().withdrawGala(acct0, acct0.getAddressU160().toBase58(), 1459535000000000L, payerAcct, 30000, 0);
                Thread.sleep(6000);
                System.out.println(zptSdk.getConnect().getSmartCodeEvent(hash));
            }
