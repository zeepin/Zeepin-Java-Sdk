...
public class DeployDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        com.github.zeepin.account.Account acct6 = new com.github.zeepin.account.Account(Helper.hexToBytes(privatekey6), SignatureScheme.SHA256WITHECDSA);
        com.github.zeepin.account.Account acct7 = new com.github.zeepin.account.Account(Helper.hexToBytes(privatekey7), SignatureScheme.SHA256WITHECDSA);
        ...
        if (false) { //deploy
            ...
            com.github.zeepin.account.Account senderAcct = acct1;
