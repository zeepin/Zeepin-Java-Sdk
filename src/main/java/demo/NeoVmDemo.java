...
import com.github.zeepin.smartcontract.neovm.abi.Struct;
...
public class NeoVmDemo {
    ...
    public static void main(String[] args) {
        try {
            ...
            Account acct1 = new Account(Helper.hexToBytes(privatekey1), zptSdk.defaultSignScheme);
            Account acct2 = new Account(Helper.hexToBytes(privatekey2), zptSdk.defaultSignScheme);
            Account acct = new Account(Helper.hexToBytes(privatekey0), zptSdk.defaultSignScheme);
            ...
            if(false){
                ...
                Object obj =  zptSdk.neovm().sendTransaction(Helper.reverse("638119357dd210e0d7661f779526690af5e3cf8e"),null,null,0,0,func, true);
