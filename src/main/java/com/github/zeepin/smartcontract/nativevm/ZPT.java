...
import com.github.zeepin.core.asset.*;
...
//        System.out.println("params:"+Helper.toHexString(params));
        ...
        Transaction tx = sdk.vm().buildNativeParams(new Address(Helper.hexToBytes(ZPTContract)),"transfer",args,payer,gaslimit, gasprice);
        return tx;
    }
    ...
    public long queryBalanceOf(String address) throws Exception {
        ...
        Transaction tx = sdk.vm().buildNativeParams(new Address(Helper.hexToBytes(ZPTContract)),"balanceOf",arg,null,0,0);
    ...
    public long queryAllowance(String fromAddr, String toAddr) throws Exception {
        ...
        Transaction tx = sdk.vm().buildNativeParams(new Address(Helper.hexToBytes(ZPTContract)),"allowance",arg,null,0,0);
        Object obj = sdk.getConnect().sendRawTransactionPreExec(tx.toHexString());
        String res = ((JSONObject) obj).getString("Result");
        if (res == null || res.equals("")) {
            return 0;
    ...
    public Transaction makeApprove(String sender, String recvAddr, long amount, String payer, long gaslimit, long gasprice) throws Exception {
        ...
        byte[] args = NativeBuildParams.createCodeParamsScript(list);
        Transaction tx = sdk.vm().buildNativeParams(new Address(Helper.hexToBytes(ZPTContract)),"approve",args,payer,gaslimit, gasprice);
        return tx;
    }
    ...
    public Transaction makeTransferFrom(String sender, String fromAddr, String toAddr, long amount, String payer, long gaslimit, long gasprice) throws Exception {
        ...
        byte[] args = NativeBuildParams.createCodeParamsScript(list);
        Transaction tx = sdk.vm().buildNativeParams(new Address(Helper.hexToBytes(ZPTContract)),"transferFrom",args,payer,gaslimit, gasprice);
        return tx;
    }
    ...
    public String queryName() throws Exception {
        Transaction tx = sdk.vm().buildNativeParams(new Address(Helper.hexToBytes(ZPTContract)),"name",new byte[]{0},null,0,0);
    ...
    public String querySymbol() throws Exception {
        Transaction tx = sdk.vm().buildNativeParams(new Address(Helper.hexToBytes(ZPTContract)),"symbol",new byte[]{0},null,0,0);
        Object obj = sdk.getConnect().sendRawTransactionPreExec(tx.toHexString());
        String res = ((JSONObject) obj).getString("Result");
        return new String(Helper.hexToBytes(res));
    }
    ...
    public long queryDecimals() throws Exception {
        Transaction tx = sdk.vm().buildNativeParams(new Address(Helper.hexToBytes(ZPTContract)),"decimals",new byte[]{0},null,0,0);
        Object obj = sdk.getConnect().sendRawTransactionPreExec(tx.toHexString());
        String res = ((JSONObject) obj).getString("Result");
        if (("").equals(res)) {
            return 0;
    ...
    public long queryTotalSupply() throws Exception {
        Transaction tx = sdk.vm().buildNativeParams(new Address(Helper.hexToBytes(ZPTContract)),"totalSupply",new byte[]{0},null,0,0);
        Object obj = sdk.getConnect().sendRawTransactionPreExec(tx.toHexString());
        String res = ((JSONObject) obj).getString("Result");
        if (res == null || res.equals("")) {
            return 0;
