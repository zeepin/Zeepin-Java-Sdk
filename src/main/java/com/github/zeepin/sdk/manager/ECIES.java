...
public class ECIES {
    ...
    public static String[] Encrypt(String pubkey, byte[] msg, int keylen) {
        try {
            com.github.zeepin.account.Account account = new com.github.zeepin.account.Account(false, Helper.hexToBytes(pubkey));
    ...
    public static byte[] Decrypt(byte[] prikey, byte[] IV, byte[] key_cxt, byte[] ciphertext, int keylen) {
        try {
            com.github.zeepin.account.Account account = new com.github.zeepin.account.Account(prikey, signatureScheme);
