...
package com.github.zeepin.core.scripts;

public enum ScriptOp {
    // Constants
    OP_PUSH0(0x00), // An empty array of bytes is pushed the stack. (This is not a no-op: an item is added to the stack.)
    OP_PUSHF(OP_PUSH0),
    OP_PUSHBYTES1(0x01), // 0x01-0x4B The next opcode bytes is data to be pushed zpto the stack
    OP_PUSHBYTES75(0x4B),
    OP_PUSHDATA1(0x4C), // The next byte contains the number of bytes to be pushed zpto the stack.
    OP_PUSHDATA2(0x4D), // The next two bytes contain the number of bytes to be pushed zpto the stack.
    OP_PUSHDATA4(0x4E), // The next four bytes contain the number of bytes to be pushed zpto the stack.
    OP_PUSHM1(0x4F), // The number -1 is pushed the stack.
    //OP_RESERVED(0x50), // Transaction is invalid unless occuring in an unexecuted OP_IF branch
    OP_PUSH1(0x51), // The number 1 is pushed the stack.
    OP_PUSHT(OP_PUSH1),
    OP_PUSH2(0x52), // The number 2 is pushed the stack.
    OP_PUSH3(0x53), // The number 3 is pushed the stack.
    OP_PUSH4(0x54), // The number 4 is pushed the stack.
    OP_PUSH5(0x55), // The number 5 is pushed the stack.
    OP_PUSH6(0x56), // The number 6 is pushed the stack.
    OP_PUSH7(0x57), // The number 7 is pushed the stack.
    OP_PUSH8(0x58), // The number 8 is pushed the stack.
    OP_PUSH9(0x59), // The number 9 is pushed the stack.
    OP_PUSH10(0x5A), // The number 10 is pushed the stack.
    OP_PUSH11(0x5B), // The number 11 is pushed the stack.
    OP_PUSH12(0x5C), // The number 12 is pushed the stack.
    OP_PUSH13(0x5D), // The number 13 is pushed the stack.
    OP_PUSH14(0x5E), // The number 14 is pushed the stack.
    OP_PUSH15(0x5F), // The number 15 is pushed the stack.
    OP_PUSH16(0x60), // The number 16 is pushed the stack.
    ...
    // Stack
    OP_TOALTSTACK(0x6B), // Puts the input the top of the alt stack. Removes it from the main stack.
    OP_FROMALTSTACK(0x6C), // Puts the input the top of the main stack. Removes it from the alt stack.
    ...
    OP_DEPTH(0x74), // Puts the number of stack items the stack.
