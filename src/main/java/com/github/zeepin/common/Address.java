...
import static com.github.zeepin.crypto.KeyType.ECDSA;
import static com.github.zeepin.crypto.KeyType.SM2;
...
public class Address extends UIntBase implements Comparable<Address> {
    ...
    public static final byte COIN_VERSION = 80;
...
//        return new UInt160(Helper.reverse(v));
    ...
    public static Address decodeBase58(String address) throws SDKException {
        ...
        byte[] checksum = Digest.sha256(data, 0, 21);
        for (int i = 0; i < 4; i++) {
