...
public class ErrorCode {
    ...
    //GIdTx Error
    public static String NullCodeHash = getError(58003, "GIdTx Error,null codeHash");
    ...
    public static String DidNull = getError(58006, "GIdTx Error,SendDid or receiverDid is null in metaData");
    public static String NotExistCliamIssuer = getError(58007, "GIdTx Error,Not exist cliam issuer");
    public static String NotFoundPublicKeyId = getError(58008, "GIdTx Error,not found PublicKeyId");
    public static String PublicKeyIdErr = getError(58009, "GIdTx Error,PublicKeyId err");
    public static String BlockHeightNotMatch = getError(58010, "GIdTx Error,BlockHeight not match");
    public static String NodesNotMatch = getError(58011, "GIdTx Error,nodes not match");
    public static String ResultIsNull = getError(58012, "GIdTx Error,result is null");
    public static String CreateGIdClaimErr = getError(58013, "GIdTx Error, createGIdClaim error");
    public static String VerifyGIdClaimErr = getError(58014, "GIdTx Error, verifyGIdClaim error");
    public static String WriteVarBytesError = getError(58015, "GIdTx Error, writeVarBytes error");
    public static String SendRawTransactionPreExec = getError(58016, "GIdTx Error, sendRawTransaction PreExec error");
    public static String SenderAmtNotEqPasswordAmt = getError(58017, "GIdTx Error, senders amount is not equal password amount");
    public static String ExpireErr = getError(58017, "GIdTx Error, expire is wrong");
    public static String GetStatusErr(String msg){return getError(58017, "GetStatus Error," + msg);} ;


    //ZPTAsset Error
    public static String AssetNameError = getError(58101, "ZPTAsset Error,asset name error");
    public static String DidError = getError(58102, "ZPTAsset Error,Did error");
    public static String NullPkId = getError(58103, "ZPTAsset Error,null pkId");
    public static String NullClaimId = getError(58104, "ZPTAsset Error,null claimId");
    public static String AmountError = getError(58105, "ZPTAsset Error,amount or gas is less than or equal to zero");
    public static String ParamLengthNotSame = getError(58105, "ZPTAsset Error,param length is not the same");
    ...
    //ZPTSdk Error
    public static String WebsocketNotInit = getError(58301, "ZPTSdk Error,websocket not init");
    public static String ConnRestfulNotInit = getError(58302, "ZPTSdk Error,connRestful not init");
